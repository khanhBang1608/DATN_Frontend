...
<template>
  <main>
    ...
    <div class="container product-sticky-toolbar d-flex flex-responsive justify-content-between align-items-start mt-2"
              ...
              <div class="accordion product-accordion" id="filterAccordionMobile">
                <div class="product-accordion-item">
                  <h2 class="accordion-header" id="headingColorMobile">
                    <button class="accordion-button accordion-btn collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseColorMobile" aria-controls="collapseColorMobile" aria-expanded="false">
                      <i class="bi bi-chevron-down me-2 rotate-icon"></i>
                      MÀU SẮC
                    </button>
                  </h2>
                  <div id="collapseColorMobile" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                      <ul class="list-unstyled mb-2">
                        ...
                        <li class="d-flex align-items-center mb-2">
                          <input type="checkbox" class="form-check-input me-2" />
                          <span class="color-dot me-2" style="background-color: white; border: 1px solid #ccc"></span>
                ...
                <div class="product-accordion-item">
                  <h2 class="accordion-header" id="headingSizeMobile">
                    <button class="accordion-button accordion-btn collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseSizeMobile" aria-expanded="false" aria-controls="collapseSizeMobile">
                      <i class="bi bi-chevron-down me-2 rotate-icon"></i>
                      KÍCH THƯỚC
                    </button>
                  </h2>
                  <div id="collapseSizeMobile" class="accordion-collapse collapse"
                    data-bs-parent="#filterAccordionMobile">
                    <div class="accordion-body">
                ...
                <div class="product-accordion-item">
                  <h2 class="accordion-header" id="headingPriceMobile">
                    <button class="accordion-button accordion-btn collapsed ps-3" type="button"
                  ...
                  <div id="collapsePriceMobile" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                      <div class="range-slider mb-3">
                        <input type="range" class="form-range price-range-slider" min="0" max="10000000" step="100000"
                          id="priceMinMobile" />
                        <input type="range" class="form-range price-range-slider" min="0" max="10000000" step="100000"
                          id="priceMaxMobile" />
                      </div>
                      <div class="d-flex justify-content-between">
                        <div class="form-group me-2">
                          ...
                          <input type="text" class="form-control" id="priceFromMobile" value="1,690,000" />
                        </div>
                        <div class="form-group">
                          <label class="form-label small">Đến</label>
                          <input type="text" class="form-control" id="priceToMobile" value="4,190,000" />
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="accordion" id="filterAccordionDesktop">
            <div class="product-accordion-item">
              <h2 class="accordion-header" id="headingColorDesktop">
                <button class="accordion-button accordion-btn collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseColorDesktop" aria-expanded="false" aria-controls="collapseColorDesktop">
                  <i class="bi bi-chevron-down me-2 rotate-icon"></i>
                  MÀU SẮC
                </button>
              </h2>
              <div id="collapseColorDesktop" class="accordion-collapse collapse"
                data-bs-parent="#filterAccordionDesktop">
                <div class="accordion-body">
                  <ul class="list-unstyled mb-2">
                    <li v-for="color in colors" :key="color.colorId" class="d-flex align-items-center mb-2">
                      <input type="checkbox" class="form-check-input me-2" v-model="selectedColors"
                        :value="color.colorId" />
                      <!-- Nếu không có hexCode trong DB thì có thể random hoặc để màu xám -->
                      <span class="color-dot me-2" :style="{ backgroundColor: color.hexCode || '#ccc' }"></span>
            ...
            <div class="product-accordion-item">
              <h2 class="accordion-header" id="headingSizeDesktop">
                <button class="accordion-button accordion-btn collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseSizeDesktop" aria-expanded="false" aria-controls="collapseSizeDesktop">
                  <i class="bi bi-chevron-down me-2 rotate-icon"></i>
                  KÍCH THƯỚC
                </button>
              </h2>
              <div id="collapseSizeDesktop" class="accordion-collapse collapse"
                data-bs-parent="#filterAccordionDesktop">
                <div class="accordion-body">
                  <ul class="list-unstyled mb-0">
                    <li class="mb-2">
            ...
            <div class="product-accordion-item">
              <h2 class="accordion-header" id="headingPriceDesktop">
                <button class="accordion-button accordion-btn collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapsePriceDesktop" aria-expanded="false" aria-controls="collapsePriceDesktop">
                  <i class="bi bi-chevron-down me-2 rotate-icon"></i>
                  GIÁ
                </button>
              </h2>
              <div id="collapsePriceDesktop" class="accordion-collapse collapse"
                data-bs-parent="#filterAccordionDesktop">
                <div class="accordion-body">
                  <div class="range-slider mb-3">
                    <input type="range" class="form-range" min="0" max="10000000" step="100000" id="priceMinDesktop" />
                    <input type="range" class="form-range" min="0" max="10000000" step="100000" id="priceMaxDesktop" />
                  </div>
                  <div class="d-flex justify-content-between">
                    <div class="form-group me-2">
                      <label class="form-label small">Từ</label>
                      <input type="text" class="form-control price-input" id="priceFromDesktop" value="1,690,000" />
                    </div>
                    <div class="form-group">
                      <label class="form-label small">Đến</label>
                      <input type="text" class="form-control price-input" id="priceToDesktop" value="4,190,000" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="container mt-5">
            ...
            <div v-if="product.variants && product.variants.length > 0" class="col-6 col-sm-6 col-md-4 col-lg-3">
              <a href="#" class="product-link" @click.prevent="handleProductClick(product.productId)">
                <div class="product-item">
                  ...
                  <img :src="product.variants[0]?.imageName
                      ? `http://localhost:8080/images/${product.variants[0].imageName}`
                      : '/default.jpg'
                    " class="img-fluid img-default" :alt="`${product.name} Hover`" />
                  <img :src="product.variants[1]?.imageName
                ...
                <div>
                  ...
                  <span class="original-price" v-if="
                ...
                <div class="product-rating">
                  ...
                  <span class="ms-1 text-muted">({{ product.averageRating?.toFixed(1) || "0.0" }})</span>
                </div>
        ...
        <ul class="pagination mt-3">
          ...
          <li v-for="page in totalPages" :key="page" class="pagination-item"
            :class="{ 'pagination-active': page - 1 === currentPage }" @click="goToPage(page - 1)">
            {{ page }}
          </li>
          <li class="pagination-item pagination-arrow"
            :class="{ 'pagination-disabled': currentPage === totalPages - 1 }" @click="goToPage(currentPage + 1)">
            &gt;
          </li>
        </ul>
      </div>
